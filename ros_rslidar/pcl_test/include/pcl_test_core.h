...
#define CLIP_HEIGHT 1.43 //截取掉高于雷达自身4米的点
// #define CLIP_HEIGHT2  -1.5
#define MIN_DISTANCE 1.2
#define RADIAL_DIVIDER_ANGLE 0.18
#define SENSOR_HEIGHT 1.07

#define concentric_divider_distance_ 0.1 //0.1 meters default
#define min_height_threshold_ 0.05
#define local_max_slope_ 20   //max slope of the ground between points, degree
